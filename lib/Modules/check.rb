module Check
  def year_built
    ...
    year_built.nil? ? "-- " : year_built.text
  end
  ...
  def time_on_market
    ...
    time_on_market.nil? ? "-- " : time_on_market.text
  end
  ...
  def est_mo_payment
    ...
    est_mo_payment.nil? ? "-- " : est_mo_payment
  end
